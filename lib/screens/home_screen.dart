...
import 'package:cureheal/themes/theme.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _shareDataToAPI(String base64Image) async {
    try {
      ...
      Dio dio = Dio();
      dio.options.connectTimeout = const Duration(seconds: 5000); // milliseconds
      dio.options.receiveTimeout = const Duration(minutes: 5); // milliseconds
